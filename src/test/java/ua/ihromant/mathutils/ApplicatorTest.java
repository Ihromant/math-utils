...
public class ApplicatorTest {
    ...
    private record OrbitState(FixBS block, FixBS stabilizer, FixBS filter, FixBS selfDiff, int size) {
        private OrbitState acceptElem(OrbitApplicator applicator, FixBS globalFilter, int val, int v, int k) {
...
//                }
            ...
            return new OrbitState(newBlock, newStabilizer, newFilter, newSelfDiff, sz);
        }
    }
